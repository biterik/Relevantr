...
_Updated 2026-09-16T08:34:34Z (UTC) · machine-readable: [VITALS.json](VITALS.json) · full history: [history.ndjson](history.ndjson) · daily snapshots: [snapshots/](snapshots/)_

| | |
|---|---|
| Repository created | 2025-08-06 |
| Tracked by repo-vitals since | 2026-08-17 (31 days)³ |
...
Everything recorded so far, from 2026-08-17 (31 days) — the total, and the same total expressed as an average rate.

| Metric | Total | Average / 30 d |
|---|---:|---:|
| Views | 19 | 18.4 |
| Unique visitors¹ | 13 | 12.6 |
| Clones | 121 | 117.1 |
| Unique cloners¹ | 64 | 61.9 |
| Stars gained | 1 | 1.0 |
| Release downloads gained | 1 | 1.0 |
...
**Conversion funnel (30 d):** 13 unique visitors → 63 unique cloners → 0 stars gained → 1 downloads gained
...
|---|---:|---:|
| `/biterik/Relevantr` | 12 | 8 |
| `/biterik/Relevantr/blob/main/README.md` | 2 | 2 |
| `/biterik/Relevantr/actions/workflows/test.yml` | 1 | 1 |
| `/biterik/Relevantr/releases` | 1 | 1 |
...
|---|---|---:|
| v2.0.0 | 2026-09-03 | 0 |
| v2.0.0-rc1 | 2026-08-31 | 1 |

Total release downloads: **1** — GitHub's lifetime
counter, which starts at each release's publication, not at the tracking start
date above (+1 in 30 d).

## Activity (last 30 days)

8 commits · 0 PRs opened / 0 merged · 0 issues opened / 0 closed · 1 contributors total
...
[reports/biterik-Relevantr-2026-09-16.md](reports/biterik-Relevantr-2026-09-16.md)
